...
public class HistoryOrderServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<OrderFullDTO> orderss = dao.getAllOrdersWithDetails();
        ...
        for (int i = 0; i < orderss.size(); i++) {
            if (orderss.get(i).getStatus().equals("Accepted")
                    || orderss.get(i).getStatus().equals("Pending")) {
                if (orderss.get(i).getUserId() == u.getId()) {
