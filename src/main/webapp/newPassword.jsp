<%-- 
    ...
    Created on : Jun 17, 2025, 9:55:01 PM
    Author     : tung
--%>
...
<html>
    ...
    <body>
        ...
        <!-- Form OTP -->
        <div>
            <form action="new-password" method="post" class="login-form">
                <h3 style="color: #4CAF50; text-align: center;">🔒 Forgot Your Password</h3>
                ...
                <input type="password" name="reNewPassword" placeholder="Enter your new Repassword" required 
                       style="width: 100%; padding: 10px; margin-bottom: 15px; border-radius: 4px; border: 1px solid #ccc;" />
